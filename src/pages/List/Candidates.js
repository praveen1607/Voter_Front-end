                  ...
                  this.state.showUserInfo ? (
                    <>
                      <div className="userInfo">
                        <p className="username">{this.state.selectedUser.name}</p>
                        <p className="branch">Branch : {this.state.selectedUser.branch} branch</p>
                        <p className="dob">DOB : {moment(this.state.selectedUser.dob).format("MMM Do YY")}</p>
                        ...
                        <button className="btn userInfo_btn" onClick={()=>{
                          this.changeRole(this.state.selectedUser.collegeID,this.state.selectedUser.role)
